...
import fetchResult from "./keys/mainKey";
...
function App() {
  ...
  const handleLikesClick = (item: Item): void => {
    console.log("Liked item:", item);
  };

  const handleAuthorClick = (item: Item): void => {
    console.log("Author clicked for item:", item);
  };
